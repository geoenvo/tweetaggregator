"""
Django settings for tweetaggregator project.
...
ROOT_URLCONF = 'tweetaggregator.urls'
...
WSGI_APPLICATION = 'tweetaggregator.wsgi.application'
...
CRONJOBS = [
    ('0 * * * *', 'aggregator.cron.tweet_scheduled_job', '>> /tmp/tweet_scheduled_job.log'),
]

# Twitter API
CONSUMER_KEY = 'sYinutLQ8yFG3rCFTZGhusyMY'
